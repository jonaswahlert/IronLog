...
const s = StyleSheet.create({
  ...
  avatarCircle:       { width: 132, height: 132, borderRadius: 66, backgroundColor: '#1c2030', borderWidth: 2, borderColor: '#22273a', alignItems: 'center', justifyContent: 'center', overflow: 'visible' },
