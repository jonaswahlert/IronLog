...
const s = StyleSheet.create({
  ...
  machineThumb:    { width: 88, height: 88, borderRadius: 14, backgroundColor: '#242840', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' },
  machineImg:      { width: 88, height: 88 },
