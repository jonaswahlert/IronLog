...
const s = StyleSheet.create({
  ...
  machineThumb:   { width: 80, height: 80, borderRadius: 14, backgroundColor: '#242840', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' },
  machineImg:     { width: 80, height: 80 },
