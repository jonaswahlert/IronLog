...
const GUIDE = {
  sv: {
    ...
    appSteps: [
      ...
      { step: '4', h: 'Tränat här förut? Välj i listan', p: 'Nästa gång du tränar på samma maskin: välj den bara i din sparade lista — ingen ny skanning behövs. Osäker på vilken maskin som är rätt? Tryck på bilden (🔍) för att zooma in och se den närmare.' },
  ...
  en: {
    ...
    appSteps: [
      ...
      { step: '4', h: 'Used it before? Pick it',   p: 'Next time on the same machine: just select it from your saved list — no need to scan again. Not sure which one is right? Tap the photo (🔍) to zoom in and see it more closely.' },
