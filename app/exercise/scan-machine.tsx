  ...
  async function capture() {
    ...
    try {
      ...
      const publicUrl = uploadData
        ? supabase.storage.from('machine-images').getPublicUrl(uploadData.path).data.publicUrl
        : null;

      // AI identification via Edge Function (placeholder returns mock data)
...
async function identifyMachine(base64: string): Promise<AIResult> {
